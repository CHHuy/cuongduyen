...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([
  [819],
  {
    ...
    6866: (e, t) => {
      ...
      const n = elementorFrontendConfig.urls.assets,
        ...
        i = elementorFrontendConfig.experimentalFeatures.e_swiper_latest
          ? `third-party/swiper/v8/swiper${o}.js?ver=8.4.5`
          : `third-party/swiper/swiper${o}.js?ver=5.3.6`,
        r = elementorFrontendConfig.experimentalFeatures.e_swiper_latest
          ? `third-party/swiper/v8/css/swiper${o}.css?ver=8.4.5`
          : `third-party/swiper/css/swiper${o}.css?ver=5.3.6`;
      AssetsLoader.assets = {
        script: {
          dialog: { src: `third-party/dialog/dialog${o}.js?ver=4.9.3` },
          "share-link": {
            src: `third-party/share-link/share-link${o}.js?ver=${s}`,
          },
          swiper: { src: i },
        },
        style: {
          ...
          "e-lightbox": {
            src: `assets/css/conditionals/lightbox${o}.css?ver=${s}`,
          },
          dialog: {
            src: `assets/css/conditionals/dialog${o}.css?ver=${s}`,
            parent: "head",
    ...
    59: (e, t, n) => {
      n.p = elementorFrontendConfig.urls.assets + "assets/js/";
    },
    4375: (e, t) => {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
